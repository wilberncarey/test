...
<div data-role="header">
 ...
 <a class="logo" style="z-index: 9998;position:fixed"><%=request.getServerName()%> - (<%=request.getLocalName()%>) </a>
...
<div style="z-index: 9998;" data-role="panel" id="defaultpanel" data-theme="b" data-position="right" data-position-fixed="true" data-display="overlay">
