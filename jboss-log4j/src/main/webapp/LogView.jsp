...
<%!
    ...
    private static final String RESTRICT_PATH = "/apps/logs;";
     ...
     */
    private static final String CSS_NAME = "css/main1.css";
    /**
...
%>
 ...
 <h3 style="text-align: center">Log Viewer</h3>
...
<%
			...
			for (int i = 0; i < entry.length; i++) {
				...
				if (!forbidden) {
					...
					out.println(" &nbsp;<a class=\"ui-btn ui-mini ui-corner-all ui-btn-b\" href=\"" + browser_name + "?sort=" + sortMode
							+ "&amp;dir=" + name + "\">[" + buf + "]</a>");
			...
			if (entry != null && entry.length > 0) {
				...
				for (int i = 0; i < entry.length; i++) {
					...
					String ahref = "<a data-role=\"button\" data-mini=\"true\" data-position=\"right\" data-position-fixed=\"true\" data-theme=\"a\" onmousedown=\"dis()\" href=\"" + browser_name + "?sort="
							+ sortMode + "&amp;";
					...
					if (entry[i].isDirectory()) {
						if (entry[i].canRead() && USE_DIR_PREVIEW) {
							...
							link = ahref + "dir=" + name + "\" title=\"" + filenames + "\" data-iconpos=\"right\" data-icon=\"forward\">"
									+ FOL_IMG + "[" + buf + "]</a>";
						}
						...
						if (entry[i].canRead()) {
							dlink = ahref + "downfile=" + name + "\" data-iconpos=\"right\" data-role=\"button\" data-position=\"right\" data-position-fixed=\"true\" data-theme=\"a\" data-icon=\"arrow-d\" target=\"_blank\">Download</a>";
							//If you click at the filename
							if (USE_POPUP) link = ahref + "file=" + name + "\" data-mini=\"true\" data-role=\"button\" data-iconpos=\"right\" data-position=\"right\" data-position-fixed=\"true\" data-icon=\"search\" class=\"ui-btn-active ui-shadow ui-btn-corner-all ui-mini ui-btn-up-b\" data-role=\"button\" data-position=\"right\" data-position-fixed=\"true\" data-theme=\"b\" target=\"_blank\">"
									+ buf + "</a>";
