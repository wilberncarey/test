...
<%!
	...
	private static final String RESTRICT_PATH = System.getProperty("BatchDir");
...
<%
    out.println("<br><b style=\"padding-left: 30px;\">Run a script as " + System.getProperty("BatchUser") + " in the base directory of " + System.getProperty("BatchDir") + "</b><br>");
String temp = System.getProperty("BatchUser");


if (temp.equals("root")) {
	out.println("running Command as " + System.getProperty("BatchUser")+ " is not Allowed!!!!" + "<BR>" + "Please change user property" + "<BR>");	
	
        }        
       

else  if (temp.equals("jbossadmin")) {
        	out.println("running Command as " + System.getProperty("BatchUser")+ " is not Allowed!!!!" + "<BR>" + "Please change user property" + "<BR>");	
        }
else if (System.getProperty("BatchDir") == null) {
	out.println("Batch Directory is unknown Please set this system Property" + "<BR>");	
}
else{
out.println("<form class=\"form-horizontal\" data-ajax=\"false\" METHOD=\"GET\" NAME=\"myform\" ACTION=\"\">");
out.println("<div style=\"display: table\" data-enhance=\"false\"  style=\"padding-left: 140px;width: 50%!important\" data-role=\"fieldcontain\">");
out.println("<div style=\"padding-left: 30px;display: table-cell\">");
out.println("<INPUT size=\"50%\" data-position=\"right\" data-enhance=\"false\" TYPE=\"text\" NAME=\"cmd\">");
out.println("</div>");
out.println("<div style=\"padding-left: 30px;display: table-cell\">");
out.println("<INPUT data-position=\"right\" data-icon=\"action\" data-enhance=\"false\" TYPE=\"submit\" VALUE=\"Launch Script\">");
out.println("</div>");
out.println("</div>");
out.println("</form>");
out.println("<pre>");
    Process prun = null;
    String[] arrayrun = { "sudo", "su", System.getProperty("BatchUser"),"-c", System.getProperty("BatchDir")+"/"+request.getParameter("cmd")};
    ...
    while ( disrrun != null ) {
    	 out.println("running Command: " + request.getParameter("cmd") + "<BR>");
            out.println(disrrun); 
